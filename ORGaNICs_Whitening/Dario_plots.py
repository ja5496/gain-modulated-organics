...
if __name__ == "__main__":
    ...
    final_gains_uni = gains_hist_VM_0[:, -1]
    final_u_uni = u_hist_VM_0[:, -1]
    final_a_uni = a_hist_VM_0[:, -1]

    print("Adapting to Ensemble A (Von Mises at 90 degrees)...")
    ...
    final_gains_uni = gains_hist_VM_90[:, -1]
    final_u_uni = u_hist_VM_90[:, -1]
    final_a_uni = a_hist_VM_90[:, -1]

    print("Adapting to Ensemble A (Uniform)...")
